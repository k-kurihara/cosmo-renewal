    ...
    $('.smart-cf-field-type-select select').each(function(index, element){
      ...
      if(name.indexOf(pattern1) > -1){
        ...
        if(val == "lp_area1"){
          ...
          $('select[name="smart-custom-fields[lp_area_a][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic2.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_a][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic3.png" alt=""></p></div>');
        ...
        var val = $(this).val();
        if(val == "lp_area1"){
          $('select[name="smart-custom-fields[lp_area_b][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic1.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_b][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic3.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_b][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic4.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_b][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic5.png" alt=""></p></div>');
        ...
        var val = $(this).val();
        if(val == "lp_area1"){
          $('select[name="smart-custom-fields[lp_area_c][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic1.png" alt=""></p></div>');
          $('textarea[name="smart-custom-fields[c_lp_step_blue_title_primary][' + str2 + ']"]').parent().parent().parent().parent().css('display','table');
        }else if(val == "lp_area2"){
          $('select[name="smart-custom-fields[lp_area_c][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic2.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_c][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic4.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_c][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic5.png" alt=""></p></div>');
      ...
      // alert(str2);
        ...
        if(val == "lp_area1"){
          ...
          $('select[name="smart-custom-fields[lp_area_d][' + str2 + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic2.png" alt=""></p></div>');
    ...
    $('.smart-cf-field-type-select select').change(function(){
      ...
      if(name.indexOf(pattern1) > -1){
        ...
        if(val == "lp_area1"){
          ...
          $('select[name="smart-custom-fields[lp_area_a][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic2.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_a][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic3.png" alt=""></p></div>');
        ...
        var val = $(this).val();
        if(val == "lp_area1"){
          $('select[name="smart-custom-fields[lp_area_b][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic1.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_b][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic3.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_b][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic4.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_b][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic5.png" alt=""></p></div>');
        ...
        var val = $(this).val();
        if(val == "lp_area1"){
          $('select[name="smart-custom-fields[lp_area_c][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic1.png" alt=""></p></div>');
          $('textarea[name="smart-custom-fields[c_lp_step_blue_title_primary][' + str + ']"]').parent().parent().parent().parent().css('display','table');
        }else if(val == "lp_area2"){
          $('select[name="smart-custom-fields[lp_area_c][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic2.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_c][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic4.png" alt=""></p></div>');
          ...
          $('select[name="smart-custom-fields[lp_area_c][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic5.png" alt=""></p></div>');
        ...
        if(val == "lp_area1"){
          ...
          $('select[name="smart-custom-fields[lp_area_d][' + str + ']"]').after('<div class="lp_area-image-sample"><p>表示例</p><p style="width:50%;"><img src="/assets/images/admin/lp-topic2.png" alt=""></p></div>');
