      ...
      ?>
        ...
        <?php } ?>
          ...
          <?php if( $blog_image_pc_url ){?>
            <img class="" src="<?php echo $blog_image_pc_url;?>" alt=""/>
          <?php } ?>
        ...
        <?php } ?>
          <?php if( $term_name !== '' && $term_name !== NULL ){?>
        ...
        <?php /*  投稿ループ　start */ ?>
          <?php
            ...
            foreach ($cf_group as $field_name => $field_value ) {
              $topics_area = $field_value['topics_area'];
          ...
          ?>
            ...
            <section>
              <?php if( $topics_area == "topics_area1" ) { ?>
                <?php /*  見出し start */ ?>
                <?php if( $title_text ) { ?>
                  <?php /*  見出し 出し分け */ ?>　
                ...
                <?php if( $full_text ) { ?>
                  ...
                  <?php }elseif( $column_2_image_1 == "" && $column_2_image_2 == ""){?>
                    <div class="p-topics__text"><?php echo nl2br($full_text);?></div>
                  <?php } ?>
                <?php } ?>
                ...
                <?php if( $full_text && $column_2_image_1 && $column_2_image_2 == ""){?>
                  <div class="p-topics__column__double">
                    <div class="p-topics__column__double__item"><?php echo nl2br($full_text);?></div>
                    <div class="p-topics__column__double__item--img"><?php echo wp_get_attachment_image( $column_2_image_1 , 'full' );?></div>
                  </div>
                <?php }elseif($full_text && $column_2_image_2 ){?>
                ...
                <?php }elseif($full_text  && $column_2_image_1 && $column_2_image_2 ){?>
                  <div class="p-topics__column__double--img">
              ...
              <?php /*  情報エリア start */ ?>
              <?php if( $topics_area == "topics_area2" ) { ?>
              ...
              <?php /*  動画 */ ?>　
              <?php if( $topics_area == "topics_area3" ) { ?>
                <?php if( $movie ) { ?>
